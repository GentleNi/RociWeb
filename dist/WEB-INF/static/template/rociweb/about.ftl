                    ...
                    <ul class="cf">
                        ...
                        <li class="page-collection">
                            <span class="lang-span">
                                <a href="${BASE_PATH}/article/change_lan/about"><i class="iconfont lang lang-flag zh">&#xe7a0;</i></a>
                                <i class="iconfont" style="font-size:1.5em;color:#fff;margin: 0 -8px;">&#xe610;</i>
                                <a href="${BASE_PATH}/article/change_lan/about"><i class="iconfont lang lang-flag en">&#xe79c;</i></a>                                        
                            </span>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="col sqs-col-12 span-12">
                        <div class="sqs-block html-block sqs-block-html" data-block-type="2">
                            <div class="sqs-block-content">
                                    <p class="text-align-center">Copyright (C) 2018&nbsp;ROCI All Rights Reserved.</p>
                            </div>
                        </div>
                            ...
                            <div class="sqs-block-content">
                                ...
                                <div class="sqs-svg-icon--outer social-icon-alignment-center social-icons-color-white social-icons-size-medium social-icons-shape-circle social-icons-style-knockout">
                                    <nav class="sqs-svg-icon--list">
                                            <a href="/" target="_blank" class="sqs-svg-icon--wrapper facebook">
                                            <div>
                                            ...
                                            <a href="/" target="_blank" class="sqs-svg-icon--wrapper twitter">
                                            <div>
                                                <svg class="sqs-svg-icon--social" viewBox="0 0 64 64">
                                            ...
                                            <a href="/" target="_blank" class="sqs-svg-icon--wrapper instagram">
                                            <div>
                                                <svg class="sqs-svg-icon--social" viewBox="0 0 64 64">
