					...
					<section class="panel">
						...
						<div class="panel-body">
	                        ...
	                        <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">中文描述</label>
                              <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">英文描述</label>
                                <div class="col-sm-10">
                                    <script id="econtent" name="econtent" type="text/plain"
                                            style="width: 100%; height: 260px;">${folder.econtent!}</script>
                                    <script type="text/javascript">
                                    var contentEditor;
                                    $(function() {
