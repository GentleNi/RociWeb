	                  		...
	                  		<table class="table table-striped table-advance table-hover">
								...
								<#if headlineList?exists>
                            		...
                            		<tr class="gradeA odd">
                                    	...
                                    	<td>${headline.createtime?string("yyyy-MM-dd HH:mm")!}</td>
                                    	<td>
                  							<!-- Icons -->
											  ...
											  <a href="${BASE_PATH}/manage/headline/add_by_headline/${headline.headlineId!}">编辑文章</a>
                						</td>
                                	</tr>
                                	</#list>
								</#if>
