		...
		<header class="white-bg">
			<div class="container" style="background-color: #ffffff; padding: 10px;">
				...
				<a href="${BASE_PATH}/index.htm" class="logo" title="访问前台页面">
					<img src="${TEMPLATE_BASE_PATH}/images/roci.jpg" style="height: 38px;" />
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu">
						<a href="${BASE_PATH}/manage/headline/list.htm" > <i class="icon-desktop"></i> <span>产品列表</span></a>
					</li>
					<li class="">
						<a href="${BASE_PATH}/manage/article/list.htm"> <i class="icon-book"></i> <span>新闻列表</span></a>
					</li>
					<li class="">
						<a  href="${BASE_PATH}/manage/folder/update.htm?folderId=2"> <i class="icon-folder-open"></i> <span>关于</span></a>
					</li>
					<li class="">
						<a  href="${BASE_PATH}/manage/toolbar/update.htm"> <i class="icon-user"></i> <span>顶栏和底栏</span></a>
					</li>
                    <#--
					<li class="">
