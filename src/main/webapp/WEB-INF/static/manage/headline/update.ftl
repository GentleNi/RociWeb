							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" style="font-size:15px;width: 600px;" class="form-control" name="height"
										   placeholder="" id="folderName" value="${headline.height!}" >
									</input>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" style="font-size:15px;width: 600px;" class="form-control" name="width"
										   placeholder="" id="folderName" value="${headline.width!}" >
									</input>
								</div>
							</div>
	                      <div class="form-group">
	                          ...
	                          <div class="col-sm-10">
	                              <input type="text" style="font-size:15px;width: 600px;" class="form-control" name="name" value="${headline.name!}" >
	                          </div>
	                      </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" style="font-size:15px;width: 600px;" class="form-control" name="ename" value="${headline.ename!}" >
                                </div>
                            </div>
	                      <div class="form-group" style="display: none">
	                          <label class="col-sm-2 col-sm-2 control-label">产品链接</label>
	                          <div class="col-sm-10">
