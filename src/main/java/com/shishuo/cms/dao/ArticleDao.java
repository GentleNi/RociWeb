...
public interface ArticleDao {
	...
	Article getArticleByHeadlineId(String headlineId);

	List<ArticleVo> getArticleListByAdminIdAndFolderId(@Param("adminId")long adminId,
                                                       @Param("folderId")long folderId,
                                                       @Param("check")check check,
                                                       @Param("offset")long offset,
                                                       @Param("rows")long rows);
	List<Article> getArticleListByFolderId(@Param("folderId") long folderId);
}
