...
public class FolderService {
	...
	public void updateFolderById(long folderId, String name, String ename,
			FolderConstant.status status, String content, String econtent,int height, int width) {
		folderDao.updateFolderById(folderId, name, ename, status, content,econtent,
				height, width);
	}
	...
	public boolean isFolderEname(String ename) {
		if(this.getFolderByEname(ename) == null)
			return true;
		return false;
	}
